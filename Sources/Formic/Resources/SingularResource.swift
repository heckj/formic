...
public protocol SingularResource: ParsedResource {
    ...
    static func query(from: Host, logger: Logger?) async throws -> (Optional<Self>, Date)
}
...
extension SingularResource {
    ...
    public static func query(from host: Host, logger: Logger?) async throws -> (Optional<Self>, Date) {
