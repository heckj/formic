...
struct configureBastion: AsyncParsableCommand {
    ...
    mutating func run() async throws {
        ...
        try await engine.run(host: bastionHost, displayProgress: true, verbosity: verbosity, commands: [
...
//                        retry: Backoff(maxRetries: 10, strategy: .fibonacci(maxDelay: .seconds(10)))),
            ...
            ShellCommand("wget -nv  https://download.swift.org/swift-6.0.3-release/ubuntu2404/swift-6.0.3-RELEASE/swift-6.0.3-RELEASE-ubuntu24.04.tar.gz"),
            // ~17 seconds
